      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-md">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Sign in with Google to upload annual accounts
          </p>
        </div>
        <div className="mt-8">
          <button
        ...
        <p className="mt-4 text-center text-xs text-gray-500">
          Your Google account will be used to upload files to Google Drive.
          <br />
          Files will be stored in your own Drive storage.
        </p>
      </div>
    </div>
  );
